...
# Line 27 - MPN
# Line 80 - 83 - Destination table configurations
...
with models.DAG(
    "spanner-multi-read-write-profilealiases",
    ...
    launch_java_pipeline =BeamRunJavaPipelineOperator(
        ...
        pipeline_options={
            ...
            'destinationTable' : "profile_aliases",
            # indexes
            'profileAliasesTableIndexName' : "trace_id,pg_id",
            'tracesTableIndexName' : "trace_id,marketing_program_number",
            'profileTraitsTableIndexName' : "pg_id,marketing_program_number",
            'MPN' : MPN

        },
        job_class="dataflow.spanner.SpannerMultipleReadWriteProfileAliases",
        dataflow_config={
            "location": "us-east4",
            "job_name" : f"profilealiasesmigration_{MPN}"    
